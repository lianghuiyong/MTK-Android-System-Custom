...
public class AudioManager {
	...
	*@hide The audio stream for MATV */
    ...
    public static final int[] DEFAULT_STREAM_VOLUME = new int[] {
        SystemProperties.getInt("ro.custom.voice.call", 12),  // STREAM_VOICE_CALL
        SystemProperties.getInt("ro.custom.voice.system", 12),  // STREAM_SYSTEM
        SystemProperties.getInt("ro.custom.voice.ring", 12),  // STREAM_RING
        SystemProperties.getInt("ro.custom.voice.music", 12), // STREAM_MUSIC
        SystemProperties.getInt("ro.custom.voice.alarm", 12),  // STREAM_ALARM
        SystemProperties.getInt("ro.custom.voice.notification", 12),  // STREAM_NOTIFICATION
        SystemProperties.getInt("ro.custom.voice.bluetooth.sco", 12),  // STREAM_BLUETOOTH_SCO
        SystemProperties.getInt("ro.custom.voice.system.enforced", 12),  // STREAM_SYSTEM_ENFORCED
        SystemProperties.getInt("ro.custom.voice.dtme", 12), // STREAM_DTMF
        SystemProperties.getInt("ro.custom.voice.tts", 12),  // STREAM_TTS
        SystemProperties.getInt("ro.custom.voice.fm", 12),  // STREAM_FM
        SystemProperties.getInt("ro.custom.voice.matv", 12)  // STREAM_MATV
    };
    /** @ */
