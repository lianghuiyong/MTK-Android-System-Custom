...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private void loadSystemSettings(SQLiteDatabase db) {
        ...
        try {
			...
			loadSetting(stmt, Settings.System.SCREEN_BRIGHTNESS,
					Integer.toString(SystemProperties.getInt("ro.def.screen.brightness", R.integer.def_screen_brightness)));
    ...
    private void loadSecureSettings(SQLiteDatabase db) {
        ...
        try {
            ...
            String defaultIME = SystemProperties.get("ro.default.input.method", IMEFeatureOption.DEFAULT_INPUT_METHOD);
            Log.i(TAG, "defaultIME : " + defaultIME);
			Log.d(TAG, "defaultIME : " + defaultIME);
            if (defaultIME != null) {
