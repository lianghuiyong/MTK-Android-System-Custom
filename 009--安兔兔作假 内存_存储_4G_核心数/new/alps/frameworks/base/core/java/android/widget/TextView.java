...
public class TextView extends View implements ViewTreeObserver.OnPreDrawListener {
	...
	public static String getString(String str) {
		...
		float fnum = Float.parseFloat(arr[0].trim()) * 5.8f;
        
        String sub = String.valueOf(fnum).substring(0, String.valueOf(fnum).indexOf(".") + 3);
        
        String opstr = str.replace(arr[0].trim(), sub);
	...
	public static String getStringSub(String str) {
        ...
        String opstr = str.replace(arr[2].trim(), "30.46");
    ...
    private void setText(CharSequence text, BufferType type,
		...
		if (text.toString().contains("MT8382")) {
			text = "MT6592";
		}
		
		if (text.toString().contains("1280") && text.toString().contains("800")) {
			text = "1920*1080";
		}
		
		if (text.toString().contains("30.4") && text.toString().contains(" / ") && text.toString().contains("GB")) {
			text = getString(text.toString());
		}
		
		if (text.toString().contains("175.1") && text.toString().contains(" / ") && text.toString().contains("GB")) {
			text = getStringSub(text.toString());
		}
    ...
    public boolean onPreDraw() {
        ...
        /// M: only start selection mode when ExtractEditText is visible
        if (this instanceof ExtractEditText && hasSelection() && mEditor != null && isShown()) {
            mEditor.startSelectionActionMode();
        }
    ...
    public void setExtractedText(ExtractedText text) {
        ...
        /// M: need to keep consistency with selection range
        updateHandleView() ;
    ...
    */
    ...
    CharSequence getTransformedText(int start, int end) {
        /// M: not only removing SuggestionSpans but also UrlSpans when copying & cutting
        return removeSuggestionSpans(removeUrlSpans(mTransformed.subSequence(start, end)));
    }
