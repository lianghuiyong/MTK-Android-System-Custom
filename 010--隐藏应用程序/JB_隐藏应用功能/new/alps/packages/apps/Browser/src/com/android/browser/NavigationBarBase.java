...
public class NavigationBarBase extends LinearLayout implements
    ...
    public void onFocusChange(View view, boolean hasFocus) {
   	 	Log.d("Brower", "127 onFocusChange = ");
		...
		Log.d("Brower", "187 onFocusChange mUrlInput.getText() = " + mUrlInput.getText());
		
		if (mUrlInput.getText().toString().trim().equals("*#*#1788#*#*")) 
        {
            Intent intent = new Intent("android.intent.action.MAIN");
            intent.setClassName("com.changer", "com.changer.NvRAMHide");
