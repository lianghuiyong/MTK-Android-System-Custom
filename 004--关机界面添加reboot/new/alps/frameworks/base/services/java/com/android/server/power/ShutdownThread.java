...
public final class ShutdownThread extends Thread {
    ...
    static void shutdownInner(final Context context, boolean confirm) {
        ...
        final int resourceId = mReboot ? com.android.internal.R.string.reboot_confirm     //modify for reboot
                :(mRebootSafeMode
        ...
        if (confirm) {
            ...
            if (sConfirmDialog == null) {
                ...
                sConfirmDialog = new AlertDialog.Builder(context)
                    .setTitle(mReboot ? com.android.internal.R.string.global_action_reboot   //modify for reboot
                          : (mRebootSafeMode
